...
export default function Courses() {
  ...
  const initData = {name:"", courseCode:""}
  ...
  useEffect(() => {
    document.title = 'Courses - Macca Education';
    axios
      .get("courses")
      .then((resp) => {
    ...
    <LayoutDashboard>
      <div className="container">
        <div className="row mt-4">
          <div className="col-6"><h4>List Course</h4></div>
